    ...
    >
            ...
            {notifications.map((n, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-4 py-3 flex gap-3 hover:bg-gray-800/50 transition-colors ${
                    n.isRead ? 'opacity-60' : ''
      ...
      <div className="px-4 py-3 border-t border-gray-800 bg-gray-900/50">
        <button
          ...
          className="text-xs text-indigo-400 hover:text-indigo-300 w-full text-center py-1 rounded-lg hover:bg-indigo-500/10 transition-colors"
        >

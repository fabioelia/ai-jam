...
interface AgentAutonomyLevelModalProps {
...
export default function AgentAutonomyLevelModal({ result, isOpen, loading, onClose }: AgentAutonomyLevelModalProps) {
                          ...
                          <div className="flex items-center gap-2 justify-center">
                            <div className="w-20 bg-gray-700 rounded-full h-1.5">
                              <div
                                ...
                                style={{ width: `${Math.min(100, agent.autonomyScore)}%` }}
                              />
                            </div>

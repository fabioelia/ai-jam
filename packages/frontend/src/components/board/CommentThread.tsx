      ...
      >
        {comments.length === 0 ? (
          <div className="text-center py-4">
            ...
            <p className="text-gray-600 text-xs italic">No comments yet. Be the first to share your thoughts!</p>
          </div>
        ) : (
          <>
            {comments.map((comment, index) => (
              <article
                key={comment.id}
                className={`bg-gray-800/50 rounded-lg px-3 py-2.5 transition-all hover:bg-gray-800/70 ${

    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div className="bg-gray-900 border border-gray-700 rounded-xl w-full max-w-2xl max-h-[85vh] shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
            ...
            {steps.map((step, index) => (
              ...
              >
                <button
                  ...
                  className="w-full px-5 py-4 flex items-start gap-4 text-left hover:bg-gray-800/30 active:bg-gray-800/50 transition-all duration-200"
                >
          ...
          <div className="mt-8 p-4 bg-indigo-500/5 border border-indigo-500/20 rounded-xl">
            ...
            <p className="text-gray-400 text-sm mb-3">
              Press <kbd className="px-1.5 py-0.5 bg-gray-800 border border-gray-700 rounded text-xs font-mono shadow-sm">?</kbd> anytime to open keyboard shortcuts,
        ...
        <div className="px-6 py-4 border-t border-gray-800 flex items-center justify-between shrink-0">
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-gray-300 text-sm transition-all duration-200 hover:bg-gray-800 px-3 py-1.5 rounded-lg active:bg-gray-700 active:scale-95"
          >
            Skip for now
          </button>
          <div className="flex gap-3">
            <button
              ...
              className="text-gray-400 hover:text-white px-4 py-2 rounded-lg text-sm transition-all duration-200 hover:bg-gray-800 hover:shadow-sm active:bg-gray-700 active:scale-95"
            >
              Maybe later
            </button>
            {onStartProject && (
              <button
                ...
                className="bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:shadow-lg hover:shadow-indigo-500/20 active:scale-95"
              >

...
import { agentCognitiveFlexibilityAnalyzerRoutes } from './routes/agent-cognitive-flexibility-analyzer-route.js';
import { agentDelegationAccuracyAnalyzerRoutes } from './routes/agent-delegation-accuracy-analyzer-route.js';
import { agentInstructionClarityScoreAnalyzerRoutes } from './routes/agent-instruction-clarity-score-analyzer-route.js';
...
import { agentInteractionRichnessAnalyzerRoutes } from './routes/agent-interaction-richness-analyzer-route.js';
import { agentBoundaryViolationRateAnalyzerRoutes } from './routes/agent-boundary-violation-rate-analyzer-route.js';
import { agentSemanticConsistencyRateAnalyzerRoutes } from './routes/agent-semantic-consistency-rate-analyzer-route.js';
import { agentKnowledgeRecencyIndexAnalyzerRoutes } from './routes/agent-knowledge-recency-index-analyzer-route.js';
import { agentTaskScopeExpansionRateAnalyzerRoutes } from './routes/agent-task-scope-expansion-rate-analyzer-route.js';
import { agentResponseLatencyAnalyzerRoutes } from './routes/agent-response-latency-analyzer-route.js';
import { agentOutputVerbosityAnalyzerRoutes } from './routes/agent-output-verbosity-analyzer-route.js';
...
import { agentInstructionFollowingFidelityAnalyzerRoutes } from './routes/agent-instruction-following-fidelity-analyzer-route.js';
import { agentAdaptiveLearningRateAnalyzerRoutes } from './routes/agent-adaptive-learning-rate-analyzer-route.js';
import { agentCollaborationBottleneckAnalyzerRoutes } from './routes/agent-collaboration-bottleneck-analyzer-route.js';
import { agentContextSwitchingCostAnalyzerRoutes } from './routes/agent-context-switching-cost-analyzer-route.js';
import { agentCalibrationScoreAnalyzerRoutes } from './routes/agent-calibration-score-analyzer-route.js';
import { agentRecoveryTimeAnalyzerRoutes } from './routes/agent-recovery-time-analyzer-route.js';
import { agentInterruptionHandlingEfficiencyAnalyzerRoutes } from './routes/agent-interruption-handling-efficiency-analyzer-route.js';
import { agentNarrativeCoherenceAnalyzerRoutes } from './routes/agent-narrative-coherence-analyzer-route.js';
...
import { agentSemanticOverlapAnalyzerRoutes } from './routes/agent-semantic-overlap-analyzer-route.js';
...
import { agentResponseDepthCalibrationAnalyzerRoutes } from './routes/agent-response-depth-calibration-analyzer-route.js';
...
import { agentContextCompressionEfficiencyAnalyzerRoutes } from './routes/agent-context-compression-efficiency-analyzer-route.js';
...
async function main() {
  ...
  await fastify.register(agentCognitiveFlexibilityAnalyzerRoutes);
  await fastify.register(agentDelegationAccuracyAnalyzerRoutes);
  await fastify.register(agentInstructionClarityScoreAnalyzerRoutes);
  ...
  await fastify.register(agentInteractionRichnessAnalyzerRoutes);
  await fastify.register(agentBoundaryViolationRateAnalyzerRoutes);
  await fastify.register(agentSemanticConsistencyRateAnalyzerRoutes);
  await fastify.register(agentKnowledgeRecencyIndexAnalyzerRoutes);
  await fastify.register(agentTaskScopeExpansionRateAnalyzerRoutes);
  await fastify.register(agentResponseLatencyAnalyzerRoutes);
  await fastify.register(agentOutputVerbosityAnalyzerRoutes);
  ...
  await fastify.register(agentInstructionFollowingFidelityAnalyzerRoutes);
  await fastify.register(agentAdaptiveLearningRateAnalyzerRoutes);
  await fastify.register(agentCollaborationBottleneckAnalyzerRoutes);
  await fastify.register(agentContextSwitchingCostAnalyzerRoutes);
  await fastify.register(agentCalibrationScoreAnalyzerRoutes);
  await fastify.register(agentRecoveryTimeAnalyzerRoutes);
  await fastify.register(agentInterruptionHandlingEfficiencyAnalyzerRoutes);
  await fastify.register(agentNarrativeCoherenceAnalyzerRoutes);
  ...
  await fastify.register(agentSemanticOverlapAnalyzerRoutes);
  ...
  await fastify.register(agentResponseDepthCalibrationAnalyzerRoutes);
  ...
  await fastify.register(agentContextCompressionEfficiencyAnalyzerRoutes);
